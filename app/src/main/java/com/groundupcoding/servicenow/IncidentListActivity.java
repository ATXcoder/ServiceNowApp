...
public class IncidentListActivity extends ActionBarActivity implements AsyncResponse {
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        nh.delegate = this;
        nh.GET(instanceURL + "/incident.do?JSONv2&sysparm_action=getRecords&displayvalue=all&sysparm_record_count=50&sysparm_query=active=true%5EORDERBYDESCnumber");
